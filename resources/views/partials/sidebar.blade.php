...
<div class="sidenav-header">
    ...
    <span class="ms-1 font-weight-bold text-white">WeLikeWork.ca</span>
    </a>
</div>
...
<div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
    ...
    <li class="nav-item">
        <a class="nav-link text-white active bg-gradient-success" href="/dashboard">
    ...
    <li class="nav-item">
        ...
        <span class="nav-link-text ms-1">Incoming Works</span>
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link text-white " href="../accepted">
        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="material-icons opacity-10">receipt_long</i>
        </div>
        <span class="nav-link-text ms-1">Accepted Works</span>
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link text-white " href="/finished">
        <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            <i class="material-icons opacity-10">view_in_ar</i>
        </div>
        <span class="nav-link-text ms-1">Finished Work</span>
        </a>
    </li>
    <li class="nav-item">
    ...
    <li class="nav-item">
        ...
        <span class="nav-link-text ms-1">Customer Pages</span>
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link text-white " href="../pages/profile.html">
